...
from .modules import DynamicGatedReLU, DynamicReLU, collect_gate_l1, validate_ratio
...
class BasicGatedBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, ratio=1.0):
